...
print('\nWelcome to the "Volume of a Cuboid Calculator".\n')

def cuboid(height, width, length):
    volume_of_cuboid = (height * width * length)
    return volume_of_cuboid

height_input = input ("Please Enter Height in Inch: ")
width_input = input ("Please Enter Width in Inch: ") 
length_input = input ("Please Enter Length in Inch: ")

height = float(height_input)
width = float(width_input)
length = float(length_input)

calculated_volume = cuboid(height, width, length)
print(f"\nThe Volume of Cuboid is: {calculated_volume} in\u00b3\n")
